...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    entities = [
        ...
        AnkerSolixSensor(coordinator, "Power L1", "power_l1", UnitOfPower.WATT, SensorDeviceClass.POWER),
        AnkerSolixSensor(coordinator, "Power L2", "power_l2", UnitOfPower.WATT, SensorDeviceClass.POWER),
        AnkerSolixSensor(coordinator, "Power L3", "power_l3", UnitOfPower.WATT, SensorDeviceClass.POWER),
